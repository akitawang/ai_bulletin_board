...
/**
 * Servlet implementation class Left_pic2_upload
 */
public class Left_pic2_upload extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Left_pic2_upload() {
        super();
