        ...
        <div id="wrapper">
            ...
            <!-- Left Sidebar End -->
					...
					<div class="form-group col-md-12">
                        	 <h4 class="header-title">社区公共信息数据操作</h4>
                         </div>
     ...
     <script>
  		 ...
  		 $(document).ready(function() {
			 $("#rec").click(function(){
   		          ...
   		          //设置linkToCart的href的值
   		          $.ajax({
	                url:"/ai_bulletin_board/Information_rectify?id="+id+"&contact="+contact+"&manager="+manager+"&time="+time+"&content="+content,
	                type:"post",
	                success:function(data){
	                	if(data > 0){
	                		alert("操作成功");
	                		 window.location.href='/ai_bulletin_board/Information_list';
	                	}
	                	else{
	                		alert("操作失败");
	                	}
    		 ...
    		 $(document).ready(function() {
    			 $("#del").click(function(){
   		          ...
   		          //设置linkToCart的href的值
   		          $.ajax({
	                url:"/ai_bulletin_board/Information_del?id="+idd,
	                type:"post",
	                success:function(data){
	                	if(data > 0){
	                		alert("操作成功");
