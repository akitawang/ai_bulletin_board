        ...
        <div id="wrapper">
            ...
            <!-- Left Sidebar End -->
					...
					<div class="form-group col-md-12">
                        	 <h4 class="header-title">添加周边公共信息</h4>
                         </div>
					<div class="general-label">
					<form method = "get" id="pass" action="/ai_bulletin_board/Surrounding_info_add">
					<div class="row">
	                      <div class="form-group col-md-6">
	                          <label for="exampleInputEmail1">联系人</label>
	                          <input type="text" class="form-control" id="manager" name="manager" placeholder="请输入添加人/负责人">
	                      </div>
	                      <div class="form-group col-md-6">
	                          <label for="exampleInputEmail1">信息类型</label>
                    ...
                    <div style="padding-left:40%;padding-top:10px">
	                      ...
	                      <a href="/ai_bulletin_board/Surrounding_info_list" class="btn btn-primary">刷新本页面</a>  
                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                        <div class="form-group col-md-12">
                        	 <h4 class="header-title">周边公共信息管理</h4>
                         </div>
                      </div>
                           ...
                           <table id="datatable-buttons" class="table table-hover mb-0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<a href="/ai_bulletin_board/tob_page/surrounding_info_info.jsp?id=${U.id}&content=${U.content}&manager=${U.manager}&type=${U.type}&time=${U.time}">
    	        ...
    	        $("#pass").submit(function(e){
    	        	...
    	        	$.ajax({
    	                ...
    	                success:function(data){
    	                	if(data > 0){
    	                		alert("操作成功");window.location.href='/ai_bulletin_board/Surrounding_info_list';
    	                	}
    	                	else{
    	                		alert("操作失败");
    	                	}
