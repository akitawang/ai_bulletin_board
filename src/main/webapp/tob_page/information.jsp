        ...
        <div id="wrapper">
            ...
            <!-- Left Sidebar End -->
					...
					<div class="form-group col-md-12">
                        	 <h4 class="header-title">添加社区公共信息</h4>
                         </div>
					<div class="general-label">
					<form method = "get" id="pass" action="/ai_bulletin_board/Information_add">
					<div class="row">
	                      <div class="form-group col-md-6">
	                          <label for="exampleInputEmail1">联系人</label>
	                          <input type="text" class="form-control" id="contact" name="contact" placeholder="请输入联系人">
	                      </div>
	                      <div class="form-group col-md-6">
                    ...
                    <div style="padding-left:40%;padding-top:10px">
	                      ...
	                      <a href="/ai_bulletin_board/Information_list" class="btn btn-primary">刷新本页面</a>  
                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                        <div class="form-group col-md-12">
                        	 <h4 class="header-title">社区公共信息管理</h4>
                         </div>
                      </div>
                           ...
                           <table id="datatable-buttons" class="table table-hover mb-0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<a href="/ai_bulletin_board/tob_page/information_info.jsp?id=${U.id}&contact=${U.contact}&content=${U.content}&manager=${U.manager}&time=${U.time}">
    	        ...
    	        $("#pass").submit(function(e){
    	        	...
    	        	$.ajax({
    	                ...
    	                success:function(data){
    	                	if(data > 0){
    	                		alert("操作成功");window.location.href='/ai_bulletin_board/Information_list';
    	                	}
    	                	else{
    	                		alert("操作失败");
    	                	}
