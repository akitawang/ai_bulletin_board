        ...
        <div id="wrapper">
            ...
            <!-- Left Sidebar End -->
					...
					<div class="form-group col-md-12">
                        	 <h4 class="header-title">紧急信息数据操作</h4>
                         </div>
					...
					<div class="row">                                  
                      ...
                      <div class="row">                                  
	                      <div class="form-group col-md-12">
	                          ...
	                          <textarea class="form-control" readonly="readonly" id="content" name="content"><%=request.getParameter("content")%></textarea>
	                      </div>
     ...
     <script>
  		 ...
  		 $(document).ready(function() {
			 $("#rec").click(function(){
   		          ...
   		          //设置linkToCart的href的值
   		          $.ajax({
	                url:"/ai_bulletin_board/Urgent_info_rectify?id="+id+"&title="+title+"&manager="+manager+"&time="+time+"&content="+content,
	                type:"post",
	                success:function(data){
	                	if(data > 0){
	                		alert("操作成功");
	                		 window.location.href='/ai_bulletin_board/Urgent_info_list';
	                	}
	                	else{
	                		alert("操作失败");
	                	}
    		 ...
    		 $(document).ready(function() {
    			 $("#del").click(function(){
   		          ...
   		          //设置linkToCart的href的值
   		          $.ajax({
	                url:"/ai_bulletin_board/Urgent_info_del?id="+idd,
	                type:"post",
	                success:function(data){
	                	if(data > 0){
	                		alert("操作成功");
